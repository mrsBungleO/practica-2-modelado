/**
 * Decorador concreto para agregar gomitas de panda al helado.
 */
public class GomitasDePanda extends IngredienteExtra {

    public static final String NOMBRE = "gomitas de panda";
     ...
     */
    public GomitasDePanda(Helado helado) {
        super(helado);
    }
    /**
